...
TAGS_OF_INTEREST = [
    ...
    "rollout/action_col_right_frac",
    "rollout/action_rot0_frac",
    "rollout/action_rot1_frac",
    "rollout/action_rot2_frac",
    "rollout/action_rot3_frac",
    # --- eval ---
    "eval/mean_reward",
